...
createCSSRule('.enter-AR-button', "position: absolute; display: block; z-index: 1; background-color: rgba(255,255,255,0); width: 200px; height: 50px; left: 50%; bottom: 20px; background-size: 100%; margin-left: -100px; cursor: pointer; outline: 0;", false, '');
addHTMLElement('a', 'enter_AR_button', 'TO', ['CONTAINER'], false);
setHTMLElemAttribute('className', 'enter-AR-button', 'enter_AR_button', false);
addHTMLElement('img', 'enter_AR_button_img', 'TO', 'enter_AR_button', false);
setHTMLElemAttribute('src', 'media/enter_AR_button.png', 'enter_AR_button_img', false);
...
createCSSRule('.warning-AR-unavailable', "position: absolute; width: 240px; height: 50px; left: 50%; margin-left: -120px; display: none;", false, '');
...
createCSSRule('.warning-could-not-enter-AR', "position: absolute; width: 181px; height: 50px; left: 50%; margin-left: -90px; display: none;", false, '');
...
createCSSRule('.info_button', "position: absolute; width: 50px; height: 50px; z-index: 1; top: 10px; right: 10px; display: block; overflow: hidden; border-style: none; border-color: #000000; cursor: pointer;", false, '');
addHTMLElement('a', 'info_button', 'TO', ['CONTAINER'], false);
setHTMLElemAttribute('className', 'info_button', 'info_button', false);
addHTMLElement('img', 'info_button_img', 'TO', 'info_button', false);
setHTMLElemAttribute('src', 'media/info.png', 'info_button_img', false);
setHTMLElemAttribute('href', 'https://www.sathvick.com', 'info_button', false);
setHTMLElemAttribute('target', '_blank', 'info_button', false);

changeVis(['GROUP', 'indicator_group'], false);
changeVis(['GROUP', 'ranbhir_group'], true);
changeVis(['drag_move', 'drag_scale', 'drag_rotate', 'scale_percentage', 'prompt_move_around', 'edit_button', 'ready_button'], false);

operateAnimation('PLAY', 'Armature', 0, 80, 'LoopRepeat', 1,
        function() {}, false);

    registerOnClick('ranbhir_mesh', false, false, [0,1,2], function() {

  operateAnimation('STOP', 'Armature', null, null, 'AUTO', 1,
          function() {}, false);


  operateAnimation('PLAY', 'Armature', 81, 157, 'LoopOnce', 1,
          function() {
...
checkARMode(function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
    enterARMode('ORIGIN', true, function() {
      changeVis(['GROUP', 'ranbhir_group'], false);
      ...
      changeVis(['drag_move', 'drag_scale', 'drag_rotate', 'scale_percentage', 'ready_button'], false);
    }, function() {
      changeVis(['GROUP', 'ranbhir_group'], true);
      setObjTransform('Armature', false, 'position', [0, 0, 0], false);
      changeVis(['GROUP', 'indicator_group'], false);
      changeVis(['drag_move', 'drag_scale', 'drag_rotate', 'scale_percentage', 'prompt_move_around', 'edit_button', 'ready_button'], false);
      setObjTransform('Armature', false, 'scale', createVector(0, 0, 0), false);
  ...
  setHTMLElemAttribute('href', exportToUSDZ('ranbhir_mesh'), 'enter_AR_button', false);
  setHTMLElemAttribute('rel', 'ar', 'enter_AR_button', false);
  setHTMLElemAttribute('download', 'ranbhir.usdz', 'enter_AR_button', false);
}, function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
...
registerOnClick('indicator_invis_plane', false, false, [0,1,2], function() {
  ...
  setObjDirection('Camera', getObjTransform('Camera', false, 'position', 'xyz'), true, true);
  changeVis(['drag_move', 'drag_scale', 'drag_rotate', 'scale_percentage', 'edit_button', 'ready_button'], false);
}, function() {});

registerOnClick('edit_button', false, false, [0,1,2], function() {
  registerSetTimeout(0.1, function() {
    changeVis('edit_button', false);
    changeVis(['drag_move', 'drag_scale', 'drag_rotate', 'scale_percentage', 'ready_button'], true);
    mode = 'edit';
  });
}, function() {});
...
registerOnDrag('drag_move', false, [0,1,2], function() {}, function() {
  dragMoveAdv('ranbhir_mesh', 'XY', 'WORLD', 'ZDS}L3Cw5;dR;|!w`0/6', 'lY2l[w*Z:a)B}5I9yW[Y');
}, function() {}, 'lY2l[w*Z:a)B}5I9yW[Y');

registerOnDrag('drag_rotate', false, [0,1,2], function() {}, function() {
  dragRotateAdv('ranbhir_mesh', 'Z', 'WORLD', 'd`yeT+m3.N*1),1pO)k)', 'Q1|bZV0fi^QD]gUIv}+6');
}, function() {}, 'Q1|bZV0fi^QD]gUIv}+6');

registerOnDrag('drag_scale', false, [0,1,2], function() {}, function() {
  dragScale('ranbhir_mesh', 'Z', 'R}CW)PE428@,[{12gnWy', 'PzY!TT8y,K](otd%km1i');
  dragScale('ranbhir_mesh', 'X', '(8.dN+E*RDwxT[u:FVFw', 'PzY!TT8y,K](otd%km1i');
  dragScale('ranbhir_mesh', 'Y', '6M?[8Anl@yA:C[/{C]v{', 'PzY!TT8y,K](otd%km1i');
  updateTextObj('scale_percentage', String(Math.round(toFixedPoint(getObjTransform('ranbhir_mesh', false, 'scale', 'z'), 2) * 100)) + '%');
}, function() {}, 'PzY!TT8y,K](otd%km1i');
